...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    private InstantistionStrategy instantiationStrategy = new CglibSubclassingInstantiationStrategy();
    ...
    public InstantistionStrategy getInstantiationStrategy() {
        return instantiationStrategy;
    }

    public void setInstantiationStrategy(InstantistionStrategy instantiationStrategy) {
